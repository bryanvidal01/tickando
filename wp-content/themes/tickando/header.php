...
<head>
    ...
    <meta name="twitter:url" content="<?php bloginfo( 'wpurl' ); ?>">
...
$gaTrackingCode = get_field( 'params_ga' , 'option');

if( !empty($gaTrackingCode) && ENV_PROD ): ?>
<script async src="https://www.googletagmanager.com/gtag/js?id=<?php echo $gaTrackingCode; ?>"></script>
<script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', <?php echo $gaTrackingCode; ?>);
</script>
<?php endif; ?>
